...
![](https://github.com/dinesh991-cntrl/Crop_and_weed_detection/blob/master/performing_detection/data/detection/detection.jpg)



![](https://github.com/dinesh991-cntrl/Crop_and_weed_detection/blob/master/performing_detection/data/detection/detection_1.jpeg)
...
# Data
we using our dataset uploaded on [kaggle](https://www.kaggle.com/dinesh991-cntrl/crop-and-weed-detection-data-with-bounding-boxes).
...
Data on https://www.kaggle.com/dinesh991-cntrl/crop-and-weed-detection-data-with-bounding-boxes
 ...
 * First of all you need anaconda, if you don't have click here for [Download](https://www.anaconda.com/products/individual) and install.
   ...
   ```
   (base) C:\Users\user> git clone https://github.com/dinesh991-cntrl/Crop_and_weed_detection.git
    ```  
...
### Using pytorch
   ...
   * After that open [performing_detection_with_pytorch.ipynb](https://github.com/dinesh991-cntrl/Crop_and_weed_detection/blob/master/performing_detection/pytorch/performing_detection_with_pytorch.ipynb) and follow alonge. After this you will able to detect crop and weed from images. Explore images from [images](https://github.com/dinesh991-cntrl/Crop_and_weed_detection/blob/master/performing_detection/data/images) folder.
...
### Using OpenCV:-
  ...
  * open [detection_with_opencv.ipynb](https://github.com/dinesh991-cntrl/Crop_and_weed_detection/blob/master/performing_detection/opencv/detection_with_opencv.ipynb) and just run cell. Play with parameters and [images](https://github.com/dinesh991-cntrl/Crop_and_weed_detection/blob/master/performing_detection/data/images). cheers....!


If you have any doubts feel free to ask any quesion at any time:)  
  * LinkedIn:  https://www.linkedin.com/in/dinesh991-cntrl/  
  * Twitter:   www.twitter.com/dinesh991-cntrl
  * Instagram: https://www.instagram.com/dinesh991-cntrl/  
